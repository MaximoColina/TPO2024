...
<div> <img src="./imagenes/1.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/2.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/3.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/4.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/5.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/6.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/7.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/9.png" alt="imagen vino" class="img-item"> </div>
...
<div class="box-imagen"> <img src="./imagenes/10.png" alt="imagen vino" class="img-item"> </div>
...
if (cargar == 1) {
  ...
  agregaProducto11.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/11.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto12.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/12.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto13.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/13.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto14.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/14.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto15.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/15.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto16.innerHTML = `<div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/16.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto17.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/17.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto18.innerHTML = ` <div class="item">
    ...
    <div class="box-imagen"> <img src="./imagenes/18.png" alt="imagen vino" class="img-item"> </div>
...
if (cargar == 1) {
  ...
  agregaProducto21.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/21.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $6.200    </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div>`;
  ...
  agregaProducto22.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/22.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto23.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/23.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $2.590    </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div>`;
  ...
  agregaProducto24.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/24.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto25.innerHTML = `<div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/25.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $7.390    </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div> `;
  ...
  agregaProducto26.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/26.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $5.220    </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div>`;
  ...
  agregaProducto27.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/27.png" alt="imagen vino" class="img-item"> </div>
  ...
  agregaProducto28.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/28.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $6.240   </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div>`;
  ...
  agregaProducto29.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/29.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $6.200   </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div> `;
  ...
  agregaProducto30.innerHTML = ` <div class="item">
        ...
        <div class="box-imagen"> <img src="./imagenes/30.png" alt="imagen vino" class="img-item"> </div>
        <div class="precio-item"> $3.990    </div>
        <button class="boton-item">Agregar al Carrito</button>
        </div>`;
...
/* Actualizamos el total de Carrito Menu */
function actualizarTotalCarritoMenu() {
  /* seleccionamos el contenedor carrito */
  var carritoContenedor = document.getElementsByClassName("carrito")[0];
  var carritoItems = carritoContenedor.getElementsByClassName("carrito-item");
  var total = 0;
  ...
  document.getElementsByClassName("menu-precio")[0].innerText =
    "$" + total.toLocaleString("es");
}
...
menuCarrito.addEventListener("click", () => {
  ...
  if (carritoVisible == false && cont != 0) {
    hacerVisibleCarrito();
    carritoVisible = true;
  } else {
    ocultarCarrito();
